  ...
  <SafeAreaView style={styles.safe}>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.btns}>
        ...
        <AppButton title="Crear cuenta" onPress={() => navigation.navigate('Register')} variant="outline" style={styles.secondBtn} />
      </View>
    </View>
  </SafeAreaView>
);
...
const styles = StyleSheet.create({
  ...
  container:{flex:1,width:'100%',maxWidth:440,alignSelf:'center',paddingHorizontal:28,paddingVertical:20},
